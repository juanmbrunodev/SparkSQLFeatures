...
public class SparkSQLFeatures {
    ...
    private void init() throws Exception {
        ...
        //Use a MapFuction, inline function, to transform the DataFrame into a new one
        ...
        //Now convert to a schema that is based on a POJO, for the tags to be process in our Java scope.
